...
The final authorized local scratch intervention, mAP50-based checkpoint selection, is complete for both historical 960 protocols. It does not modify the dataset, labels, folds, image-processing variants, model initialization, loss, optimizer, augmentation, or inference settings. The result improves both custom architectures, with the Faster R-CNN result now reaching 66.5% of the pretrained YOLO11n reference mAP50 but still below its $0.4799 \pm 0.0262$ value. No candidate public-test evaluation or further unregistered sweep is warranted from these selection data.
