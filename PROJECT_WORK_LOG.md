...
>
> **Last updated:** 2026-07-26 — strict-scratch mAP50 checkpoint selection completed for both local architectures; horizontal-flip test-time augmentation and cosine scheduling were rejected for YOLO26; a shared EMA-only strict-scratch intervention is implemented and smoke-tested but not yet trained; no candidate public-test data was used.
