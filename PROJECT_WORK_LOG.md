...
>
> **Last updated:** 2026-07-28 — the final shared train-only photometric augmentation study completed; it was mixed/neutral for YOLO26 and rejected for Faster R-CNN, so the prior raw-weight configurations remain selected; no candidate public-test data was used.
