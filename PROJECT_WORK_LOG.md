...
>
> **Last updated:** 2026-08-24 — full three-fold group-disjoint cross-validation completed for both custom architectures under post-submission letterbox geometry (`runs/yolo26/post_submission_letterbox` and `runs/faster_rcnn/post_submission_letterbox`). Letterbox is formally adopted as the geometry standard for the practical track (+25.2% mAP50 gain for YOLO26, parity preserved for Faster R-CNN); submitted strict-scratch baselines remain frozen.
